...
//----------------------------------------------------------------------------
  ...
  public:
    ...
    {
      auto ye = y + h;
      auto buf = (M5RGBColor*)alloca(w * sizeof(M5RGBColor));
...
#pragma GCC diagnostic ignored "-Wmaybe-uninitialized"
      ...
      pixelcopy_t pc_write(buf    ,_write_depth, M5RGBColor::depth, false);
#pragma GCC diagnostic pop
      pixelcopy_t pc_read( nullptr, M5RGBColor::depth, _read_depth, false);
      startWrite();
      do
      {
