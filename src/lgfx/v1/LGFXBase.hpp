...
//----------------------------------------------------------------------------
    ...
    LGFX_INLINE   M5RGBColor*     getPalette(void) const { return getPalette_impl(); }
...
//----------------------------------------------------------------------------
    ...
    M5RGBColor readPixelRGB(int32_t x, int32_t y)
    {
      M5RGBColor data[1];
    ...
    void readRectRGB( int32_t x, int32_t y, int32_t w, int32_t h, M5RGBColor* data)
    {
      pixelcopy_t p(nullptr, bgr888_t::depth, _read_conv.depth, false, getPalette());
...
//----------------------------------------------------------------------------
  ...
  protected:
    ...
    virtual M5RGBColor* getPalette_impl(void) const { return nullptr; }
